...
> Автоматического retry нет. Повторная обработка запускается вручную из соответствующего регистра сведений.
...
**Документация:** [README](../README.md) · [Архитектура](architecture.md) · [Установка и настройка](setup.md) · [Настройка подсистемы](configuration.md) · [Руководство пользователя](usage.md) · [Эксплуатация](operations.md) · [Руководство разработчика](development.md) · [Глоссарий](glossary.md)
