...
Приветствуются предложения, сообщения об ошибках и pull request'ы в [репозитории на GitHub](https://github.com/ShadobaAI/kafka-adapter). Как оформить issue и PR, как ведутся задачи проекта — [Участие в разработке](../project/contributing.md).
