...
<!-- TODO: проверить актуальность admin-enable.png — основная форма панели администрирования переработана (#33): плитки «Настройка подключения», «Очереди сообщений», «Служебные сущности», «Управление подсистемой» -->
