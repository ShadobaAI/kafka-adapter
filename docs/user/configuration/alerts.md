...
!!! warning "Секреты — через «Режим пароля»"
    Токен бота — чувствительное значение. В параметрах брокера или других полях, где он может храниться, используйте **Режим пароля**.
