...
| Источник регистрации | Тип `Объект` |
|----------------------|--------------|
| Подписка на запись ссылочного объекта | Объект (`СправочникОбъект`, `ДокументОбъект` и т.п.) |
| Подписка на запись набора РС (режим **Независимый**) | `РегистрСведенийНаборЗаписей` / запись набора |
| Подписка на запись регистра по регистратору | **Ссылка на регистратор** (документ) |
| `ПоместитьВОчередьИсходящих(Ссылка)` | Переданное значение |
