...
Готовые рецепты для типовых задач. Основаны на реальном коде из [тестового проекта](https://github.com/ShadobaAI/kafka-adapter-examples).
...
-   :material-table-split-cell:{ .lg } **[Строки как отдельные сообщения](outgoing-split-rows.md)**

    ---

    Разбить ТЧ справочника или движения регистратора на независимые сообщения.
