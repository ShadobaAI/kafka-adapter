...
| **[Simple Kafka Connector 1C](https://github.com/NuclearAPK/Simple-Kafka_Adapter)** | 1.9.1+ | Внешняя компонента (DLL); уже встроена в подсистему — отдельная установка нужна только при её обновлении |
