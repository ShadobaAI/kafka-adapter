...
Три подписки, охватывающие все ссылочные объекты и наборы записей регистров:
...
| `кфкЗарегистрироватьИзмененияНабораПриЗаписи` | ПриЗаписи (наборы записей) | Регистрация изменений наборов записей регистров |
