...
Проект использует следующие открытые инструменты и библиотеки:
...
**Тестирование:**
- **[YAxUnit](https://github.com/bia-technologies/yaxunit)** — фреймворк для юнит-тестирования на платформе 1С:Предприятие. Обработка `ГенераторСлучайныхЗначений` из [репозитория тестера](https://github.com/ShadobaAI/kafka-adapter-tester) создана по образцу одноимённого общего модуля из этого проекта.
